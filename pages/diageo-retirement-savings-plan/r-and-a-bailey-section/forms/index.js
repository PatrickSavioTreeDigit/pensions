...
export default function Ireland({ formsContent, formslinks }) {
          ...
          <Row>
            ...
            <Col xl={14} lg={14} md={14} sm={24} xs={24} className='right-col'>
              ...
              <div className='download-document'>
                ...
                <a target='_blank' href='https://media.diageo.com/diageo-corporate-media/media/dwcpnbkx/drsp-fund-switch-form-jan-19.pdf'>
                  {formsContent.pdf2}
                  </a>
                </span>
              </div>
