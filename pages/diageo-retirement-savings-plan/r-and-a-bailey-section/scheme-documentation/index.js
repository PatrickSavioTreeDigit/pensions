        ...
        <div className='diageo-container'>
          <Row>
            ...
            <Col xl={14} lg={14} md={14} sm={24} xs={24} className='right-col'>
              ...
              <div className='download-document'>
                <DownloadOutlined className='download-document-icon' />
                <Link aria-label="Read more about scheme of diageo pensions" target='_blank' href="https://media-diageo.diageoplatform.com/diageo-corporate-media/media/ozqffg2e/drsp-trustee-report-and-accountsto-june-2022.pdf"><span className='download-document-span'>
                  {schemeContent.pdf2}
                </span></Link>
              </div>
            </Col>
