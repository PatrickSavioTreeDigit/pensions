    ...
    {show && <div className='diageo-retirement-savings-plan-container'>
      <div className='blue-color-container'>
        <div className='diageo-container'>
          ...
          / <span>{formsContent.text3}</span>{' '}
          <Row justify={'center'}>
            <Col span={24}>
              <span className='heading'>
                <h2>{formsContent.text3}</h2>
              </span>
            </Col>
          </Row>
        </div>
...
export async function getStaticProps() {
  ...
  const res = await client.getEntries({ content_type: "formsGuinnessStorehouseSection", "fields.text": "Diageo Retirement Savings Plan" })
